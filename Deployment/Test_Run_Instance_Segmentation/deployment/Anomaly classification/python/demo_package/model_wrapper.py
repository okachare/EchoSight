...
class ModelWrapper:
    ...
    def __init__(self, model_dir: Path, device: str = "CPU") -> None:
        ...
        task_type = self.parameters.get("task_type") or self.parameters.get("model_type", "")
        task_type = task_type.upper().replace("ANOMALYDETECTION", "CLASSIFICATION").replace("ANOMALY_DETECTION", "CLASSIFICATION")
